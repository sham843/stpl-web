...
const routes: Routes = [
  ...
  { path: 'job-details/:id', loadChildren: () => import('../../web/career/job-details/job-details.module').then(m => m.JobDetailsModule) },
  ...
  { path: 'project-details/:id', loadChildren: () => import('../../web/projects/project-details/project-details.module').then(m => m.ProjectDetailsModule) },
  { path: 'solution-details/:id', loadChildren: () => import('../../web/solutions/solution-details/solution-details.module').then(m => m.SolutionDetailsModule) },
