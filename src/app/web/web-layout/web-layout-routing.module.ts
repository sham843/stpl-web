...
const routes: Routes = [
  ...
  { path: 'amcu', loadChildren: () => import('../../web/solutions/amcu/amcu.module').then(m => m.AmcuModule) },
  { path: 'kims', loadChildren: () => import('../../web/solutions/kims/kims.module').then(m => m.KimsModule) },
  { path: 'election-mgmt-system', loadChildren: () => import('../../web/solutions/election-mgmt-system/election-mgmt-system.module').then(m => m.ElectionMgmtSystemModule) },
  { path: 'mahamining-system', loadChildren: () => import('../../web/solutions/mahamining-system/mahamining-system.module').then(m => m.MahaminingSystemModule) },
  { path: 'dairy-vet-software', loadChildren: () => import('../../web/solutions/dairy-vet-software/dairy-vet-software.module').then(m => m.DairyVetSoftwareModule) },
